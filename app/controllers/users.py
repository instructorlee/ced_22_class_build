...
"""
    - give username / email ( personal identifier ) - Done
    - validations ( password conditions ; certain lengths; all fields required; values ; confirm passwords; checking for unique account)
    - create record
"""
